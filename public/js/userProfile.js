...
function displayUserBooks(userBooks,mode)
{
  ...
  userBooks.forEach(element => {
    ...
    tableBody.innerHTML+='<tr><td><a href="/book/singlebook"><img id="'+element.book_id._id+'" width="50px; height="100px;" src="img/'+element.book_id.photoName+'"></a></td><td>'+element.book_id.name+'</td><td>'+element.rating+'/5</td>'+gettingDropDown(element.status,element.book_id._id)+'</tr>'
  });
}
